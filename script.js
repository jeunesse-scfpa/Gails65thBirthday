...
/* ──────────────────────────────────────────────────────────────
   YOUTUBE PLAYER — Ladies Night by Kool & the Gang
   ────────────────────────────────────────────────────────────── */
let ytPlayer    = null;
let ytReady     = false;
...
function handleRSVPSubmit(e) {
  ...
  window.location.href = `mailto:ghusky1992@gmail.com?body=${encodeURIComponent(body)}&subject=${encodeURIComponent("RSVP – Gail's 65th Birthday")}`;
